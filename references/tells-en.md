...
1. Coined compounds and shorthand (feeds mechanism 5): term-locking, counter-probe, mutation-checked, re-derived, "the unlock".
...
3. High-register clan (feeds mechanism 5): delve, crucial, testament, pivotal, furthermore; plainly, quietly, vacuous, settles, survives.
   Example: "Furthermore, delving deeper reveals a design that is a testament to restraint."
4. Engineering metaphor bank (feeds mechanism 5): load-bearing, blast radius, seams, cutover, earns its keep.
